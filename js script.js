...
function HitungTotal(){
    ...
    if ((Tujuan=='Palopo') && (Kelas=='Eksekutif'))
    {
        HargaTiket = 70000;
    }

    else if ((Tujuan=='Toraja') && (Kelas=='Bisnis'))
    {
        HargaTiket = 40000;
    }

    else if ((Tujuan=='Toraja') && (Kelas=='Ekonomi'))
    {
        HargaTiket = 10000;
    }

    else if ((Tujuan=='Pare-pare') && (Kelas=='Eksekutif'))
    {
        HargaTiket = 80000;
    }

    else if ((Tujuan=='Pare-pare') && (Kelas=='Bisnis'))
    {
        HargaTiket = 50000;
    }

    else if ((Tujuan=='Pare-pare') && (Kelas=='Ekonomi'))
    {
        HargaTiket = 20000;
    }

    else if ((Tujuan=='Palopo') && (Kelas=='Eksekutif'))
    {
        HargaTiket = 90000;
    }

    else if ((Tujuan=='Palopo') && (Kelas=='Bisnis'))
    {
        HargaTiket = 60000;
    }

    else if ((Tujuan=='Palopo') && (Kelas=='Ekonomi'))
    {
        HargaTiket = 30000;
    }
